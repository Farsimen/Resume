...
class ResumeApp {
        ...
        headerEl.innerHTML = `
            <div class="header-main">
                ...
                <div class="profile-photo" aria-label="Profile photo placeholder">
                    ${photo
                        ? `<img src="${photo}" alt="${data.personal.name}" class="profile-photo-image">`
                        : `<span class="profile-photo-placeholder">Photo</span>`}
                </div>
            </div>
        `;
    }
    ...
    renderSummary(summary) {
        return this.renderAccordion(summary.title, `<div class="summary-text">${summary.text}</div>`, true);
    }
    ...
    renderCoreCompetencies(competencies) {
        ...
        return this.renderAccordion(competencies.title, `<div class="skill-cloud">${skillsList}</div>`);
    }
    ...
    renderExperience(experience) {
        ...
        return this.renderAccordion(experience.title, positions, true);
    }
    ...
    renderEntrepreneurship(entrepreneurship) {
            ...
            <div class="project-entry">
                <div class="job-header">
                    <div>
                        ...
                        ${project.url ? `<a class="project-link" href="${project.url}" target="_blank" rel="noopener">${project.url.replace(/^https?:\/\//, '')}</a>` : ''}
                    </div>
        ...
        return this.renderAccordion(entrepreneurship.title, projects);
    }
    ...
    renderEducation(education) {
        ...
        return this.renderAccordion(education.title, `${degrees}${certifications}`);
    }
    ...
    renderSkills(skills) {
        ...
        return this.renderAccordion(skills.title, `<div class="skills-container">${categories}</div>`);
    }

    renderPersonality(personality) {
        return this.renderAccordion(personality.title, `
    ...
    renderAccordion(title, content, open = false) {
        return `
